const guideItems = [
  ...
  {
    title: 'STEREO',
    body: 'ステレオかどうか判別します。ステレオ:左右が違う音です。 / モノラル:左右が同じ音です。モノラル信号の可能性が高いです。 / 逆位相:左右で極性が反転しています。ケーブルが不良品の可能性があります。(時々ならば問題ありません) / 片チャンネル:信号が片方のみです。2ch分岐されていないモノラルマイクか、ケーブルの接触不良の可能性があります。',
  },
]
